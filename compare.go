...
// Example:
//
//	ver1, err := calver.NewVersion("Rel-2025-07-14", "Rel-<YYYY>-<0M>-<0D>")
//	if err != nil {
//	    return err
//	}
//	ver2, err := calver.NewVersion("Rel-2025-07-15", "Rel-<YYYY>-<0M>-<0D>")
//	if err != nil {
//	    return err
//	}
//	fmt.Printf("%d\n", ver1.Compare(ver2)) // -1
...
// compared as integer if it is an integer otherwise as a string.
